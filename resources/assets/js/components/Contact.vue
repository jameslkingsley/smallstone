<template>
    <div v-show="show" class="fixed z-50 pin bg-brand overflow-auto">
        <button class="absolute pin-t pin-r mt-4 mr-4 lg:mt-8 lg:mr-8 text-white text-5xl" @click.prevent="close">
            <i class="material-icons text-3xl md:text-5xl">close</i>
        </button>

        <div class="container w-full lg:w-1/3 py-8 lg:py-24 px-8 lg:px-0 mx-auto align-middle text-white">
            <div v-show="notSent">
                <h1 class="text-center text-2xl md:text-3xl mb-4">Just a few questions</h1>
                <p class="text-center leading-normal text-sm md:text-base mb-8 md:mb-12">
                ...
                <div class="flex flex-wrap mb-0 md:mb-2">
                    <div class="flex-1 m-1 md:m-2 w-1/2">
                ...
                <div class="flex flex-wrap">
                    <div class="flex-1 m-1 md:m-2 w-full">
